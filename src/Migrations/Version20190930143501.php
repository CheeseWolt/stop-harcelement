 ...
 */
final class Version20190930143501 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE alert CHANGE alert_manager_id alert_manager_id INT DEFAULT NULL, CHANGE start_support_date start_support_date DATETIME DEFAULT NULL, CHANGE end_support_date end_support_date DATETIME DEFAULT NULL');
